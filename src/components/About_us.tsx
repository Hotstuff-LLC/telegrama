    ...
    >
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-5xl mx-auto">
          <p className="text-gray-100 text-lg sm:text-2xl md:text-4xl lg:text-5xl mb-6 md:mb-10 drop-shadow-2xl leading-snug">
            {blok.about_text_main}
          </p>

          {/* More space between paragraphs */}
          <p className="text-gray-200 text-base pt-16 sm:text-lg md:text-xl lg:text-2xl drop-shadow-2xl leading-relaxed">
